...
function Hero() {
  return (
    <>
      <div className="container about-hero-cnt d-flex justify-content-center align-items-center mt-5 fs-4 text-center border-bottom pb-5 fw-semibold">
        <div className="row">
          <p className="lh-1">
      ...
      <div style={{ marginTop: "6rem" }} className="container">
        <div className="row d-flex ">
          <div className="col-6 para-about">
            <p className="mb-3">
